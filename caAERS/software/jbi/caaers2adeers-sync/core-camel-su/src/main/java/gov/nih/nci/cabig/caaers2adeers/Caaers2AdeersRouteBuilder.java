...
public class Caaers2AdeersRouteBuilder extends RouteBuilder {
    ...
    public void configure() {
        ...
        from("jetty:http://0.0.0.0:"+raveIntegrationServicesPort+"/caaers/services/RaveIntegrationServices?minThreads=30&maxThreads=256&httpClient.idleTimeout=60000&httpClient.timeout=60000&continuationTimeout=0")
	            .streamCaching()
                .choice()
    ...
    //check for errors 
      from("direct:rave2CaaersOutSink")
        ...
        from("jetty:http://0.0.0.0:"+participantInitializationPort+"/caaers/ParticipantInitialization?httpBindingRef=participantODMMessageBinding&minThreads=30&maxThreads=256&httpClient.idleTimeout=60000&httpClient.timeout=60000&continuationTimeout=0")
	        .streamCaching()
	        .choice() 
		        .when(header("CamelHttpMethod").isEqualTo("POST"))
