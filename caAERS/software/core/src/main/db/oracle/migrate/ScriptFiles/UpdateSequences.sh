...
EXECUTE IMMEDIATE 'DROP SEQUENCE SAFETY_REPORT_ID_GEN_SEQ';
EXECUTE IMMEDIATE 'DROP SEQUENCE SEQ_USERS_ID';
EXECUTE IMMEDIATE 'DROP SEQUENCE lab_terms_id_seq';
EXECUTE IMMEDIATE 'DROP SEQUENCE lab_categories_id_seq';
EXECUTE IMMEDIATE 'DROP SEQUENCE seq_ctc_categories_id';
EXECUTE IMMEDIATE 'DROP SEQUENCE seq_ctc_terms_id';
EXECUTE IMMEDIATE 'DROP SEQUENCE seq_ctc_grades_id';
...
EXECUTE IMMEDIATE 'CREATE SEQUENCE SAFETY_REPORT_ID_GEN_SEQ START WITH 3000';
MAX_VAL := 0;
EXECUTE IMMEDIATE 'select max(id)+200 from (select id from research_staffs union select id from investigators)' into MAX_VAL ;
EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_USERS_ID START WITH '|| MAX_VAL ||' INCREMENT BY 1 CACHE 20'; 
EXECUTE IMMEDIATE 'CREATE SEQUENCE lab_terms_id_seq START WITH 5000 INCREMENT BY 1 CACHE 20'; 
EXECUTE IMMEDIATE 'CREATE SEQUENCE lab_categories_id_seq START WITH 5000 INCREMENT BY 1 CACHE 20'; 
EXECUTE IMMEDIATE 'CREATE SEQUENCE seq_ctc_categories_id START WITH 5000 INCREMENT BY 1 CACHE 20'; 
EXECUTE IMMEDIATE 'CREATE SEQUENCE seq_ctc_terms_id START WITH 20000 INCREMENT BY 1 CACHE 20'; 
EXECUTE IMMEDIATE 'CREATE SEQUENCE seq_ctc_grades_id START WITH 100000 INCREMENT BY 1 CACHE 20'; 	   	
END;
/
quit
EOF